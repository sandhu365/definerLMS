...
import 'package:definer_lms/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<DefinerLmsFirebaseUser> userStream;
  DefinerLmsFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = definerLmsFirebaseUserStream()
